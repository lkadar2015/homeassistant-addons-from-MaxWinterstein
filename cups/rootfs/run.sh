...
bashio::log.info "${message:="1..."}"

mkdir -p /data/ssl

bashio::log.info "${message:="2..."}"
...
bashio::log.info "${message:="5..."}"

# Start CUPS
/usr/sbin/cupsd -f

bashio::log.info "${message:="6..."}"
